...
(function (){
    ...
    setTimeout(function() {
        ...
        function setText(sceneText) {
            glitcher.text = sceneText;
            glitcher.textWidth = (glitcher.context.measureText(sceneText)).width;
        }

        var countOfSeconds = 0;
        for (var i = 0; i < scenes.length; i++) {
            setTimeout(setText, countOfSeconds*1000, scenes[i][0]);
            countOfSeconds += scenes[i][1];
        }
